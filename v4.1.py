#you can now choose how much of a stock you buy, also changed growth rates to be more realistic
...
class StockMarketGame:
    ...
    def hold(self):
        for stock in self.stock_prices:
            change_percentage = random.uniform(-2, 5)
        ...
        self.message = "Held for one turn."
        self.turn += 1
